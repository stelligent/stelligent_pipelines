...
EOF
    aws s3 cp sec_int_test_results.json s3://${DEMO_RESULTS_BUCKET}/data/sec_int_test_results.json
    aws s3 cp sec_int_test_job_info.json s3://${DEMO_RESULTS_BUCKET}/data/sec_int_test_job_info.json
}
