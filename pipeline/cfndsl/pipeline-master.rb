CloudFormation do
  ...
  Resource("ZapStack") do
    ...
    Property("TimeoutInMinutes", "60")
    Property("Parameters", {
      "CfnInitRole"     => FnGetAtt("IAMStack", "Outputs.InstanceRole"),
      "Ec2Key"          => Ref("KeyName"),
  ...
  Resource("CodePipelineStack") do
    ...
    Property("TimeoutInMinutes", "60")
    Property("Parameters", {
      "ArtifactStoreBucket"     => FnGetAtt("PipelineStoreStack", "Outputs.DromedaryS3Bucket"),
      "Branch"                  => Ref("Branch"),
  ...
  Resource("rCloudFrontStack") do
    ...
    Property("TimeoutInMinutes", "60")
    Property("Parameters", {
      "pDistributionDomainName" => FnJoin("", [
        Ref("AWS::StackName"),
        "",
        Ref("ProdHostedZone")
      ])
